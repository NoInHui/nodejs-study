...
app.post('/upload', uploadAuthCheck, upload.single('image'), (req,res) => {
...
app.post('/upload2', uploadAuthCheck, upload.array('many'), (req,res) => {
...
app.post('/upload3', uploadAuthCheck, upload.fields([{name: 'image1'}, {name: 'image2'}]), (req,res) => {
    console.log(req.files, req.body);
    res.send('ok');
});
